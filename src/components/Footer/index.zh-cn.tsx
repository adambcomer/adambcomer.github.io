    ...
    <>
      ...
      <footer className='grid lg:grid-cols-12 m-6'>
          ...
          <div className='flex flex-row mt-6'>
            <div className='mr-4'>
              <OutboundLink href='mailto:adambcomer@gmail.com'>
                <svg className='icon w-8' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            ...
            <div className='mx-4'>
              <OutboundLink href='https://twitter.com/adambcomer'>
                <svg className='icon w-8' xmlns="http://www.w3.org/2000/svg" viewBox="2 2 27 27">
        ...
        <div className='lg:col-span-2 mt-12 lg:mt-0'>
          ...
          <div className='mt-2 text-lg hover:underline'><Link to='/zh-cn/'>主页</Link></div>
          <div className='mt-2 text-lg hover:underline'><Link to='/zh-cn/blog/'>Blog</Link></div>
          <div className='mt-2 text-lg hover:underline'><Link to='/zh-cn/projects/'>Projects</Link></div>
          <div className='mt-2 text-lg hover:underline'><Link to='/zh-cn/experience/'>Experience</Link></div>
        </div>

        <div className='lg:col-span-2 mt-12 lg:mt-0'>
          <div className='text-lg font-bold'>语言</div>
          <div className='mt-2 text-lg font-sc hover:underline'><Link to='/'>英语</Link></div>
          <div className='mt-2 text-lg hover:underline'><Link to='/zh-cn/'>中文</Link></div>
        </div>
