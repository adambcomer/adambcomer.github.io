      ...
      <footer className='grid lg:grid-cols-12 m-6'>
        ...
        <div className='lg:col-span-2 mt-12 lg:mt-0'>
          ...
          <div className='mt-2 text-lg hover:underline'>
            <Link to='/zh-cn/'>主页</Link>
          </div>
          <div className='mt-2 text-lg hover:underline'>
            <Link to='/zh-cn/blog/'>Blog</Link>
          </div>
          <div className='mt-2 text-lg hover:underline'>
            <Link to='/zh-cn/projects/'>Projects</Link>
          </div>
          <div className='mt-2 text-lg hover:underline'>
            <Link to='/zh-cn/experience/'>Experience</Link>
          </div>
        </div>

        <div className='lg:col-span-2 mt-12 lg:mt-0'>
          <div className='text-lg font-bold'>语言</div>
          <div className='mt-2 text-lg font-sc hover:underline'>
            <Link to='/'>英语</Link>
          </div>
          <div className='mt-2 text-lg hover:underline'>
            <Link to='/zh-cn/'>中文</Link>
          </div>
        </div>

        <div className='lg:col-span-12 mt-12 lg:mt-0'>
          © 2021 Adam Comer — All rights reserved
        </div>
      </footer>
    </>
  )
