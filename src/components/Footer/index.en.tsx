    ...
    <>
      ...
      <footer className='grid lg:grid-cols-12 m-6'>
        ...
        <div className='lg:col-span-2 mt-12 lg:mt-0'>
          ...
          <div className='mt-2 text-lg hover:underline'><Link to='/'>English</Link></div>
          {/* <div className='mt-2 text-lg hover:underline'><Link to='/zh-cn/'>Chinese (Simplified)</Link></div> */}
        </div>

        <div className='lg:col-span-12 mt-12 lg:mt-0'>© 2022 Adam Comer — All rights reserved</div>
      </footer>
    </>
  )
}
