  ...
  return (
    <>
      <Helmet htmlAttributes={{ lang: 'zh-cn' }}>
        ...
        <meta
          name='description'
          content='Adam Comer is a Software Developer, Co-Founder Knowtworthy, and Student at the University of Toronto. He is proficient with Node.js, Kubernetes, Python, and AWS.'
        />
        ...
        <meta
          property='og:image'
          content='https://adambcomer.com/portrait.png'
        />
      ...
      <main className='w-100 font-sc'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 block'>
          <StaticImage
            ...
            src='../images/bmo.jpg'
            alt='Toronto Skyline with the Bank of Montreal HQ in the center.'
          />
          <div className='w-100 px-6 py-24'>
            <h2 className='text-3xl'>
              我是<span className='color-1'>软件开发师</span>。
            </h2>
            <p className='mt-8'>
              I started writing code in early high school and haven’t stopped
              since. I used to be a freelance developer for small businesses and
              universities in the Northern Virginia area. Since starting
              University, I’ve had the opportunity to work for the Bank of
              Montreal(BMO) and eventually start my own company.
            </p>

            <div className='mt-16'>
              <Link
                className='text-xl hover:underline arrow-link ml-6'
                to='/experience/'
              >
                Experience
              </Link>
                  ...
                  <div className='svg-fill'>
                    ...
                    >
                      <g>
                        <path
                          id='arrow'
                          d='M7.5,11l4.1-4.4l0.7,0.7L7,13L1.6,7.3l0.7-0.7L6.5,11V0h1V11z'
                        />
                        <path
                          id='bottom'
                          d='M13,15v-2h1v2c0,0.6-0.4,1-1,1H1c-0.6,0-1-0.4-1-1v-2h1v2H13z'
                        />
                      </g>
                    </svg>
                  </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 block'>
          <StaticImage
            className='hidden lg:block'
            src='../images/con-hall.jpg'
            alt='Convocation Hall at the University of Toronto.'
          />
          <div className='px-6 py-24'>
            <h2 className='text-3xl'>
              我是<span className='color-2'>学生</span>。
            </h2>
            <p className='mt-8'>
              我学习 Statistics 和 Cognitive Science at the University of
              Toronto. In other words, I study data and the mind. These
              disciplines have allowed me to explore other departments such as
              Computer Science, Linguistics, and Psychology. With broad exposure
              to many domains, I’ve been able to integrate many outside ideas
              into my projects and work.
            </p>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-5 block px-6 py-16 gap-x-12'>
          <div>
            ...
            <p className='mt-2 lg:mt-4 text-sm text-1-color'>
              Read about some stuff I’m working on
            </p>
          </div>
          ...
          <div className='mt-8 lg:mt-0 lg:col-span-2 relative h-64 lg:h-full'>
            <Link to='/blog/simple-database/'>
              <div className='p-8 h-full hover:underline ui-1-color'>
                ...
                <svg
                  className='absolute bottom-8 right-8 svg-fill'
                  xmlns='http://www.w3.org/2000/svg'
                  width='32'
                  height='32'
                  viewBox='0 0 32 32'
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 block'>
          <StaticImage
            className='hidden lg:block'
            src='../images/knowtworthy.jpg'
            alt='Knowtworthy meeting minutes editor and transcription.'
          />
          <div className='px-6 py-24'>
            <h2 className='text-3xl'>
              我是<span className='color-3'>Co-Founder</span>。
            </h2>
            <p className='mt-8'>
              After my first year in university, my co-founders and I were given
              the opportunity to join the UofT’s Hatchery's NEST Program to
              build out our company: Knowtworthy. Our vision is to increase the
              efficiency of office meetings with software that implements
              meeting best practices in conjunction with automatic speech
              transcription. So far, Knowtworthy has successfully launched an
              Alpha and Beta and is now available to individuals and businesses.
            </p>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-5 block px-6 py-16 gap-x-12'>
          <div>
            ...
            <p className='mt-2 lg:mt-4 text-sm text-1-color'>
              Reach out to start a conversation with me
            </p>
          </div>
            ...
            <div>
              <OutboundLink href='mailto:adambcomer@gmail.com'>
                <div className='flex flex-row p-8 items-center contact-container'>
                  ...
                  <h4 className='text-lg lg:text-xl font-thin ml-8'>
