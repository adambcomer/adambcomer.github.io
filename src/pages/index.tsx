      ...
      <main className='px-6 md:px-12 mb-32 max-w-screen-2xl mx-auto'>
        <div className='my-24 grid grid-cols-1 md:grid-cols-12 items-center'>
          <div className='col-span-8'>
            <h1 className='md-display-large text-center md:text-left'>
              Adam Comer
            </h1>
            <p className='md-headline-medium mt-6 md:mt-2 text-center md:text-left'>
          ...
          <StaticImage
            className='col-span-4 h-fit rounded-[48px] mt-16 md:mt-0'
            src='../images/adam-comer-portrait.jpg'
            alt='Adam Comer'
            quality={90}
          />
        </div>
        ...
        <div className='mt-48'>
          ...
          <p className='m-2 text-center md-headline-small md-color-secondary'>
          ...
          <div className='relative md-surface-3 mt-8 px-6 pt-6 pb-16 md:p-12 rounded-[32px] md:rounded-[64px]'>
            ...
            <div className='grid gap-8 grid-cols-1 lg:grid-cols-2 my-4'>
              <div>
                <p className='md-body-large'>
                  ...
                  our cloud infrastructure on AWS. This is includes managing our
                  CI/CD system and Kubernetes cluster to ensure that the team’s
                  work is tested and deployed with confidence.
                </p>
                <p className='md-body-large mt-4'>
                  Outside of work, I enjoy working with Python and Rust as the
                  basis for my personal projects.
                </p>
              </div>
              <div>
                <p className='md-title-small md-on-surface-variant'>
                  Languages
                </p>
                ...
                <p className='md-title-small md-on-surface-variant mt-4'>
                  Tools
                </p>
                <div className='flex flex-wrap'>
                  <span className='md-label-large !text-white md-bg-primary px-3 py-1.5 rounded-lg mr-4 mt-2'>
            ...
            <Link to='/experience/'>
              <button className='absolute right-8 bottom-6 md:right-16 inline-flex items-center cursor-pointer md-title-large md-color-primary hover:md-color-secondary'>
                Experience <i className='material-icons ml-2'>arrow_forward</i>
              </button>
            </Link>
          </div>
          ...
          <div className='relative md-surface-3 mt-16 mt-8 px-6 pt-6 pb-16 md:p-12 rounded-[32px] md:rounded-[64px]'>
            ...
            <div>
              <p className='md-body-large my-4 lg:w-1/2'>
                ...
                putting me in charge of the technology stack. My
                responsibilities at Knowtworthy extend to every layer of stack:
        ...
        <div className='mt-32'>
          ...
          <div className='grid gap-6 grid-cols-1 lg:grid-cols-12 mt-8'>
            <Link
              to='/blog/install-gitlab-runner-kubernetes/'
            ...
            >
              <div className='md-surface-2 p-8 rounded-[32px] overflow-hidden h-full hover:md-surface-5'>
                <StaticImage
                  ...
                  src='../images/blog/post-1-cover.jpeg'
                  alt='Gitlab logo on purple background'
                />
                ...
                <p className='md-body-large mt-4 line-clamp-3'>
                  Learn how to install Gitlab CI/CD Runner on Kubernetes and
                  grant access to the Docker Daemon to build containers.
                </p>
              </div>
            </Link>
            <Link to='/blog/simple-database/' className='col-span-4'>
              <div className='md-surface-2 p-8 rounded-[32px] overflow-hidden h-full hover:md-surface-5'>
                <StaticImage
                  className='-mt-8 -mx-8 aspect-video'
                  src='../images/blog/simple-database-motivation-design-cover.jpg'
                  alt='Servers in a data center'
                />
                ...
                <p className='md-body-large mt-4 line-clamp-3'>
                  Introductory tutorial to designing and building a LSM-Tree
                  based Key-Value Store like RocksDB.
                </p>
              </div>
            </Link>
            <Link to='/blog/chess-analysis/' className='col-span-4'>
              <div className='md-surface-2 p-8 rounded-[32px] overflow-hidden h-full hover:md-surface-5'>
                <StaticImage
                  className='-mt-8 -mx-8 aspect-video'
                  src='../images/blog/post-2-cover.jpg'
                  alt='Pawns on a chessboard'
                />
                ...
                <p className='md-body-large mt-4 line-clamp-3'>
                  How does knowledge of Chess Openings relate to player rating?
                  In this analysis, I investigate the use Book Openings and
                  Master Games with a sample of 20,000 public Lichess Games.
                </p>
              </div>
            </Link>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 col-span-4 mt-8 rounded-[32px] overflow-hidden border border-[#8F909A]'>
            ...
            <a href='https://www.linkedin.com/in/adambcomer'>
              <div className='group md-title-medium md-color-primary hover:!text-black inline-flex items-center border-b border-l border-[#8F909A] hover:bg-[#D9E2FF] -ml-px px-12 py-6 w-full'>
                <i className='mr-3'>
                  <svg
                    className='w-6 fill-[#0056D2] group-hover:fill-black'
