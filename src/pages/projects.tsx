      ...
      <main className='px-6 md:px-12 max-w-screen-2xl mx-auto mb-32'>
        ...
        <div className='md-surface-2 rounded-[32px] p-6 md:p-12 max-w-screen-lg mx-auto'>
          ...
          <p className='md-body-large mt-2'>
            ...
            used in class, this tool is able to parse an annotated sentence and
        ...
        <div className='md-surface-2 rounded-[32px] p-6 md:p-12 max-w-screen-lg mx-auto mt-32'>
          ...
          <p className='md-body-large mt-2'>
            ...
            the project in React and Node.js. After 36 hours of coding, we gave
            our presentation to the judges and won first place.
          </p>
        ...
        <div className='mt-64'>
          ...
          <p className='m-2 text-center md-headline-small md-color-secondary'>
            Other projects, writings, and code
          </p>
...
export const Head = () => {
  ...
  return (
    <>
      ...
      <meta
        name='description'
        content='Things I built for fun to learn something new.'
      />

      <meta
        property='og:title'
        content='Projects | Adam Comer | Software Developer'
      />
      <meta
